...
/* ✅ TD en blanco (texto claro) */
#dynamictable tbody td,
#dynamictable tbody td *{
  color: rgba(255,255,255,.86) !important;
}

/* ✅ Links/botones dentro de TD */
...
/* ✅ Íconos feather/fontawesome/svg */
...
<body class="dashboard-body">
          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
                <div>
                  ...
                  <div style="color:var(--w70); font-size:.9rem; margin-top:6px;">
                    Control y seguimiento de compromisos por municipio, vereda, componente y estado.
                  </div>
                </div>
              ...
              <ul class="breadcrumb mt-2">
                ...
                <li class="breadcrumb-item"><a href="#!">Registro de compromisos Alcalde / Cuadro Control municipios</a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-12">
          <div class="card au-card">
            ...
            <div class="card-header d-flex flex-wrap align-items-center justify-content-between">
              <h5 class="mb-0">Listado de compromisos Alcalde</h5>
  ...
  <script>
    window.munNombre = '<?php
      $nombreMun = '';
      if (!empty($municipioUsuario)) {
          $db = new DbConection(); $pdo = $db->openConect();
          ...
          $stmt->execute([':c' => (string)$municipioUsuario]);
          $res = $stmt->fetch(PDO::FETCH_ASSOC);
          $nombreMun = $res ? (string)$res['municipio'] : '';
          $db->closeConect();
      }
      echo $nombreMun;
    ?>';
